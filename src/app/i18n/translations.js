export const translations = {
	...
	"field-inputTypes-description": "A list of Media Types (MIME Types) as mandated in RFC 6838 which the application can handle as input. In case the software does not support any input, you can skip this field or use application/x.empty.",
	...
	"field-availableLanguages-description": "If present, this is the list of languages in which the software is available. Of course, this list will contain at least one language. The primary language subtag cannot be omitted, as mandated by the BCP47.  See https://tools.ietf.org/html/bcp47",
...
Cette clef contient la date à laquelle la dernière version a été publiée. Cette date est obligatoire si le logiciel a été publié au moins une fois et que le numéro de version est donc présent.`,
	...
	"field-mainCopyrightOwner-label": "Titulaire principal de la propriété intellectuelle",
	"field-mainCopyrightOwner-description": "Cette chaîne décrit l\'entité qui détient les droits de propriété intellectuelle sur la “majeure partie” du code du référentiel. Normalement, il s\'agit de la ligne qui est signalée par le symbole de copyright en haut de la plupart des fichiers du dépôt.",
	...
	"field-authorsFile-description": "Certains logiciels open-source adoptent une convention d\'identification des détenteurs de droits de propriété intellectuelle par le biais d\'un fichier qui liste toutes les entités possèdant de tels droits. Ceci est courant dans les projets fortement soutenus par une communauté où il y a de nombreux contributeurs externes et aucun détenteur unique/principal de la propriété intellectuelle. Dans de tels cas, cette clé peut être utilisée pour se référer au fichier des auteurs, en utilisant un chemin relatif à la source du dépôt.",
	...
	"field-inputTypes-description": "Une liste des types de médias (types MIME), tels que définis dans la RFC 6838, que l\'application peut traiter en entrée. Si le logiciel ne prend en charge aucune entrée, vous pouvez ignorer ce champ ou utiliser application/x.empty.",
